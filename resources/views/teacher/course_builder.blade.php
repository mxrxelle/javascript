    ...
    <aside class="w-64 sidebar text-white flex flex-col justify-between fixed h-screen z-10">
        ...
        <div class="p-6 flex-1">
            ...
            <nav class="space-y-3">
                ...
                <a href="{{ route('teacher.dashboard') }}#submissions-section" class="text-gray-300 hover:bg-[#003b73] hover:text-white w-full flex items-center gap-3 px-4 py-3 rounded-lg transition text-left no-underline block">
